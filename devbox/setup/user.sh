...
curl -fsSL https://deno.land/install.sh | DENO_INSTALL="${INSTALL_PREFIX}" sh -s --
...
curl -fsSL "${CONFIGS_BASE_URL}/vscode/extensions.json" -o "${HOME}/workspaces/.vscode/extensions.json" --create-dirs
